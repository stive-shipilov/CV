...
\begin{center}
    \textbf{\Huge \scshape Шипилов Степан} \\ \vspace{1pt}
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    {Физтех-школа радиотехники и комьютерных технологий}{2023 -- 2027 $|$ 2 курс $|$ GPA: 9.1/10}
...
\resumeSubHeadingListStart
  \resumeSubheading
    {Основные курсы:}{}
    {\parbox{0.8\textwidth}{Математический Анализ, Линейная Алгебра, Теория Вероятности, 
    Дифференциальные уравнения, Базы данных и SQL, Информатика, Физика}}{}
\resumeSubHeadingListEnd
...
\section{Проекты}
    ...
    \resumeProjectHeading
          ...
          {\color{blue}\href{https://github.com/stive-shipilov/-University-database-design}{[GitHub]}} $|$ \emph{SQL, Git}}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Включает три модуля: работу с матрицами, анализ парковочных данных и исследование покупательской активности.}
